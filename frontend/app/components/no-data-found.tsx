import { CircleFadingPlus, LayoutGrid } from "lucide-react"
...
export const NoDataFound = ({ title, description, buttonText, buttonAction }: NoDataFoundProps) => {
    return (
        <div className="col-span-full text-center py-12 2xl:py-24 bg-muted/40 rounded-lg">
            ...
            <Button variant={"default"} onClick={buttonAction} className="mt-4 hover:bg-emerald-400"><CircleFadingPlus className="" />{buttonText}</Button>
        </div>
    )
}