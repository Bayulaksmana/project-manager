...
const MyTasks = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-start md:items-center justify-between mt-6 sm:mt-0">
                <h1 className="text-3xl font-cabella">My Tasks List</h1>
                <div
                    className="flex items-start md:flex-row md gap-2"
                    itemScope
                    gap-2
                >
                    <Button
                    ...
                    >
                        {sortDirection === "asc"
                            ? (<><ArrowDown10Icon /><span className="text-sm hidden sm:block gap-1 items-center">Old Task</span></>)
                            : (<><ArrowUp10Icon /><span className="text-sm hidden sm:block gap-1 items-center">New Task</span></>)}
                    </Button>
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant={"outline"} className="hover:bg-emerald-300 text-sm" size={"sm"}>
                                <ArrowDownNarrowWideIcon /> <span className="hidden sm:block">Filter</span>
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent>
            ...
            <Input
                placeholder="Search title tasks ...."
                value={search}
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <CardDescription className="underline flex justify-between w-xl">
                        ...
                        <CardContent>
                            <div className="divide-y">
                                {sortedTasks?.map((task) => (
                                    <div key={task._id} className="py-2 mb-2">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between w-full sm:px-6 ">
                                            <div className="bg-card hover:translate-x-1 shadow-xl rounded-xl flex p-4">
                                            ...
                                            <div className="text-sm text-muted-foreground space-y-1">
                                                {task.dueDate && (
                                                    <div>Due: {format(task.dueDate, "PPPP", { locale: id })}</div>
                                                )}
                                                <div>
                                                    Project:{" "}
                                                ...
                                                <div>Modified on: {format(task.updatedAt, "PPPP", { locale: id })}</div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                        ...
                        <Card>
                            ...
                            <CardContent className="p-3 space-y-3 max-h-[600px] overflow-y-auto">
                                {todoTasks?.map((task) => (
                                    <Card
                                        key={task._id}
                                        className="hover:shadow-md transition-shadow p-4 hover:-translate-y-1"
                                    >
                                        <Link
                                            to={`/workspaces/${task.project.workspace}/projects/${task.project._id}/tasks/${task._id}`}
                                            className="block"
