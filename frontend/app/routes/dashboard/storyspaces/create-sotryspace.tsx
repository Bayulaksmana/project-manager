...
import { Loader2, LucideLightbulb, LucideLoader2, LucideSave, LucideSend, LucideSparkles, LucideStarHalf, LucideTrash2 } from 'lucide-react';
    ...
    return (
        <div className="space-y-4 flex gap-4 flex-col lg:flex-row">
            <div className="lg:w-5/7">
                <div className="flex flex-col md:flex-row items-center justify-between mt-4 md:mt-0">
                    ...
                    <span className='flex items-center flex-wrap justify-between gap-2'>
                        ...
                        <div className="flex gap-1 items-center justify-end mt-3 md:mt-0">
                            ...
                            <Button
                                className='flex text-xs hover:bg-linear-to-r hover:from-emerald-200 hover:to-emerald-400 bg-linear-to-r from-emerald-100 to-emerald-300 text-black hover:text-emerald-900 hover:border-emerald-500 border'
                                variant={"ghost"}
                                size={"sm"}
                                disabled={loading}
                ...
                <div className="bg-slate-50 md:pt-4 rounded-2xl shadow-2xl gap-2 flex flex-col">
            ...
            <div className="lg:w-2/7 h-[55vw] overflow-y-scroll [scrollbar-width:none] [-ms-overflow-style:none]">
                <div className="bg-slate-50 rounded-2xl shadow-2xl gap-2 flex flex-col mt-4 lg:mt-0">
                    {!isEdit && (
                        <div className="form-card col-span-12 md:col-span-4 p-0">
                            <div className="flex items-center justify-between px-4">
                                ...
                                <Button onClick={generatePostAI} size={'sm'}
