...
import { achievedTask, addComment, addSubTask, createTask, getActivityByResourceId, getCommetByTaskId, getMyTasks, getTaskById, updateSubTask, updateTaskAssignees, updateTaskDescription, updateTaskPriority, updateTaskStatus, updateTaskTitle, watchTask } from '../controllers/task.js'
import authMiddleware from "../middleware/auth-middleware.js"

const router = express.Router()

router.post("/:projectId/create-task", authMiddleware, validateRequest
    ({ params: z.object({ projectId: z.string() }), body: taskSchema }),
    createTask
)
...
router.post("/:taskId/add-reaction", authMiddleware, validateRequest
    ({ params: z.object({ taskId: z.string() }) }),
    watchTask
)
